...
pub static COUNTRY_ID_TO_NAME: LazyLock<HashMap<&'static str, &'static str>> = LazyLock::new(|| {
    let m = HashMap::from([
        ("AO", "Angola"), ("AU", "Australia"), ("BF", "Burkina Faso"),
        ("BI", "Burundi"), ("BJ", "Benin"), ("BR", "Brazil"),
        ("BW", "Botswana"), ("CA", "Canada"), ("CD", "DR Congo"),
        ("CF", "Central African Republic"), ("CG", "Republic of the Congo"),
        ("CI", "Côte d'Ivoire"), ("CM", "Cameroon"), ("CN", "China"),
        ("CV", "Cape Verde"), ("DE", "Germany"), ("DJ", "Djibouti"),
        ("DZ", "Algeria"), ("EG", "Egypt"), ("EH", "Western Sahara"),
        ("ER", "Eritrea"), ("ET", "Ethiopia"), ("FR", "France"),
        ("GA", "Gabon"), ("GB", "United Kingdom"), ("GH", "Ghana"),
        ("GM", "Gambia"), ("GN", "Guinea"), ("GQ", "Equatorial Guinea"),
        ("GW", "Guinea-Bissau"), ("IN", "India"), ("JP", "Japan"),
        ("KE", "Kenya"), ("KM", "Comoros"), ("LR", "Liberia"),
        ("LS", "Lesotho"), ("LY", "Libya"), ("MA", "Morocco"),
        ("MG", "Madagascar"), ("ML", "Mali"), ("MR", "Mauritania"),
        ("MU", "Mauritius"), ("MW", "Malawi"), ("MZ", "Mozambique"),
        ...
        ("US", "United States"), ("ZA", "South Africa"), ("ZM", "Zambia"),
        ("ZW", "Zimbabwe"),
    ]);
    m
});
